...
const Button = styled.a`
  ...
  box-shadow: 6px 6px 0 ${theme.colors.ink};
  position: relative;
  ...
  &:hover {
    ...
    box-shadow: 9px 9px 0 ${theme.colors.orange};
  }
...
export default function WhatsAppButton({ label = 'Hablemos por WhatsApp', message }) {
  const url = message
